...
namespace Mobilyte\Vendor\Block\Adminhtml\News;
...
class Edit extends Container
{
   /**
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Mobilyte_Vendor';
        ...
        'delete',
            array(
                ...
                'onclick' => 'setLocation("'.$this->getUrl('mobilyte_vendor/post/delete',array('_query' => array('deleteid' => $deleteId))).'")'
            ),
            -100
        );
    ...
    {
        $newsRegistry = $this->_coreRegistry->registry('mobilyte_news');
